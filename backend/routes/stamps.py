"""
Stamps API routes for ResCanvas
...
def create_stamp():
    ...
    try:
        ...
        # Validate that either emoji or image is provided
        ...
        # Return the created stamp (without MongoDB _id)
...
def update_stamp(stamp_id):
    ...
    try:
        ...
        # Check if stamp exists and belongs to user
