...
function Blog() {
  ...
  return (
    <Box sx={{ width: 'auto', height: 'calc(100vh - var(--app-header-height, 75px) - var(--app-footer-height, 150px))', display: 'flex', flexDirection: 'column', margin: '0 auto', backgroundColor: '#f9f9f9', paddingLeft: '2rem', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
